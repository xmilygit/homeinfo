...
export default {
  ...
  methods: {
    ...mapActions("graduate", ["getGraduateInfo","modiGraduateInfoAttr","saveGraduateInfo"]),
    dialogclose() {
    ...
    result() {
      ...
      if (stulocal) {
        ...
        if(this.stuinfo.fregaddress!=5&&this.stuinfo.fregaddress!=4&&this.stuinfo.sregaddress!=5&&this.stuinfo.sregaddress!=4&&!hashouse){
          if(whohouseAlias==3){
        ...
        if(this.stuinfo.fregaddress!=5&&this.stuinfo.sregaddress!=5&&whohouseAlias!==3){
        ...
        if(hashouse){
          ...
          if(
            (this.stuinfo.fregaddress!=5&&whohouseAlias==1&&this.stuinfo.sregaddress==5)
            ||
            (this.stuinfo.sregaddress!=5&&whohouseAlias==2&&this.stuinfo.fregaddress==5)
          )
          {
            //房产所有人与学生不在同一户籍的
          ...
          //无房
          let temphomeRS=rs[1]
          if(/名义租房/gi.test(this.stuinfo.hometype))
            temphomeRS=rs[2]
          else if(/单位房/gi.test(this.stuinfo.hometype))
            temphomeRS=rs[5]
          else if(/公租房/gi.test(this.stuinfo.hometype))
            temphomeRS=rs[6]
