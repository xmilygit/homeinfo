    ...
    <f7-card-content :padding="false">
      ...
      <div style="padding:5px 5px 5px 5px">
        ...
        <f7-row style="margin-top:5px;">
          <f7-col>
            <f7-button large fill color="blue">{{stuinfo.stuname}}与{{stuinfo.fname}}同户籍</f7-button>
          </f7-col>
        </f7-row>
        <!-- 学生户口本首页地址 -->
        <f7-row style="margin-top:5px;" v-if="!stuinfo.sigle">
          <f7-col>
            <f7-button large fill color="lightblue">{{stuinfo.stuname}}与{{stuinfo.sname}}同户籍</f7-button>
          </f7-col>
        </f7-row>
        <f7-row style="margin-top:5px;">
          <f7-col>
            <f7-button large fill color="deeporange">{{stuinfo.stuname}}不与监护人同户籍</f7-button>
          </f7-col>
        </f7-row>
        <f7-row style="margin-top:5px;">
          <f7-col>
